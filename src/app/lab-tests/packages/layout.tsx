...
export const metadata = pageMetadata({
  ...
  description:
    "Compare full body checkups, diabetes, heart, hormone, fertility and cancer screening packages at Kist Poly Clinic, Lalitpur. In-house lab with home sample collection.",
