  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 mb-8">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
        <Link href="/services" className="bg-blue-600 hover:bg-blue-700 text-white py-3 px-4 rounded-lg flex items-center justify-center shadow-md transition-colors">
          <Calendar className="w-5 h-5 mr-2" />
          Book Appointment
        </Link>
        <Link href="/lab-tests" className="bg-green-600 hover:bg-green-700 text-white py-3 px-4 rounded-lg flex items-center justify-center shadow-md transition-colors">
          <Flask className="w-5 h-5 mr-2" />
          Book Lab Test
        </Link>
        <Link href="/epharmacy" className="bg-purple-600 hover:bg-purple-700 text-white py-3 px-4 rounded-lg flex items-center justify-center shadow-md transition-colors">
    ...
    <div className="bg-white rounded-lg shadow p-4 mb-4">
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center text-gray-600">
          ...
          <span>{format(new Date(`2000-01-01T${appointment.appointmentTime}`), 'h:mm a')}</span>
        </div>
        {appointment.reason && (
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        {new Date(test.testDate).toLocaleDateString()} at {test.testTime?.substring(0, 5)}
                      </p>
                      <div className="mt-2">
...
const sidebarItems = [
  ...
  { icon: ShoppingBag, label: 'Pharma Orders', id: 'products' },
